...
export const TimingSignals = {
  /**
   * سیگنال ۱۹: تست عملکرد CPU با حلقه‌های سنگین ریاضی
  ...
  /**
   * سیگنال ۲۰: تست حافظه‌ی کش و عملکرد آرایه
  ...
  /**
   * سیگنال ۲۱: زمان بارگذاری و رندرینگ صفحه
  ...
  /**
   * سیگنال ۲۲: تست عملکرد Canvas (رندرینگ)
  ...
  /**
   * سیگنال ۲۳: تست WebGL عملکردی (رندرینگ 3D)
